...
types = [
    ...
    "indicate the corrected answer to each of the",                 # hoan thanh cau
...
def crawl_test(linkz, headersz, sheet_name):
    ...
    for count, item in enumerate(items):
        ...
        # Trong am
        elif types[3] in question or types[4] in question or "the word that differs from the" in question:
            kind = "Trọng âm"
            answers = item.find_all(class_="anwser-item")
            for answer in answers:
        ...
        # Hoan thanh cau
        elif (types[5] in question and "Mark the letter" in question) or (types[6] in question and "Mark the letter" in question):
            kind = "Hoàn thành câu"
        ...
        # Tu dong nghia
            ...
            question = [x for x in get_list if x != '' and "Mark the letter" not in x][0]
            answers = item.find_all(class_="anwser-item")
            for answer in answers:
                ans = answer.get_text()
                list_answer.append(ans.lstrip("\n"))
        ...
        # Hoan thanh doan van
        elif types[9] in question or types[10] in question:
        ...
        # Tim loi sai
        elif types[11] in question or types[12] in question or "Câu Hỏi Tự Luận" in item.find(class_="question-header").get_text():
            kind = "Tìm lỗi sai"
            check = 'Mark the letter A, B, C'
        ...
        elif ': “_' in question or types[16] in question:
...
def insert():
    ...
    links = ['https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/76375/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/76454/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/76455/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/76517/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/76524/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/76620/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/76626/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/76644/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/76680/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/76699/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/76759/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/76800/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/76883/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/76909/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/76940/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/76943/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/76948/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/77167/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/77219/ket-qua',
             'https://khoahoc.vietjack.com/thi-online/20-de-thi-thu-thpt-quoc-gia-mon-tieng-anh-nam-2022/77229/ket-qua']
